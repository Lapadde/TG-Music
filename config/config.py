...
OWNER_ID = list(map(int, getenv("OWNER_ID", "5007590747 6174058850 5745099463").split()))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/zona_dewasa1")

SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/caritemanpacarr")
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://t.me/baksdudee")
